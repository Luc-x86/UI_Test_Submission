...
class Cart:
    ...
    def billing_details(self):
        self.page.locator("//select[@id='BillingNewAddress_CountryId']").click()
    ...
    def validate_order(self):
        self.page.wait_for_selector("body > div.master-wrapper-page > div.master-wrapper-content > div.master-wrapper-main > div > div > div.page-title > h1")
        expect(self.page.locator("body > div.master-wrapper-page > div.master-wrapper-content > div.master-wrapper-main > div > div > div.page-body.checkout-data > div > div.title > strong")).to_have_text("Your order has been successfully processed!")
